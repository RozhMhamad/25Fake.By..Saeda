...
client.on("ready", () => {
  console.log(`[Saeda] :  1 `);
  console.log(`Hi ${client.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client.guilds.size} " ]`);
}); // "Saeda"
client2.on("ready", () => {
  console.log(`[Saeda] :  2 `);
  console.log(`Hi ${client2.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client2.guilds.size} " ]`); //  "Saeda"
});
client3.on("ready", () => {
  console.log(`[Saeda] :  3 `);
  console.log(`Hi ${client3.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client3.guilds.size} " ]`);
});
client4.on("ready", () => {
  console.log(`[Saeda] :  4 `);
  console.log(`Hi ${client4.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client4.guilds.size} " ]`);
});
client5.on("ready", () => {
  console.log(`[Saeda] :  5 `);
  console.log(`Hi ${client5.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client5.guilds.size} " ]`);
});
client6.on("ready", () => {
  console.log(`[Saeda] :  6 `);
  console.log(`Hi ${client6.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client6.guilds.size} " ]`);
});
client7.on("ready", () => {
  console.log(`[Saeda] :  7 `);
  console.log(`Hi ${client7.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client7.guilds.size} " ]`);
});
client8.on("ready", () => {
  console.log(`[Saeda] :  8 `);
  console.log(`Hi ${client8.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client8.guilds.size} " ]`);
});
client9.on("ready", () => {
  console.log(`[Saeda] :  9 `);
  console.log(`Hi ${client9.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client9.guilds.size} " ]`);
});
client10.on("ready", () => {
  console.log(`[Saeda] :  10 `);
  console.log(`Hi ${client10.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client10.guilds.size} " ]`);
});
client11.on("ready", () => {
  console.log(`[Saeda] :  11 `);
  console.log(`Hi ${client11.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client11.guilds.size} " ]`);
});
client12.on("ready", () => {
  console.log(`[Saeda] :  12 `);
  console.log(`Hi ${client12.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client12.guilds.size} " ]`);
});
client13.on("ready", () => {
  console.log(`[Saeda] :  13 `);
  console.log(`Hi ${client13.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client13.guilds.size} " ]`);
});
client14.on("ready", () => {
  console.log(`[Saeda] :  14 `);
  console.log(`Hi ${client14.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client14.guilds.size} " ]`);
});
client15.on("ready", () => {
  console.log(`[Saeda] :  15 `);
  console.log(`Hi ${client15.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client15.guilds.size} " ]`);
});
client16.on("ready", () => {
  console.log(`[Saeda] :  16 `);
  console.log(`Hi ${client16.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client16.guilds.size} " ]`);
});
client17.on("ready", () => {
  console.log(`[Saeda] :  17 `);
  console.log(`Hi ${client17.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client17.guilds.size} " ]`);
});
client18.on("ready", () => {
  console.log(`[Saeda] :  18 `);
  console.log(`Hi ${client18.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client18.guilds.size} " ]`);
});
client19.on("ready", () => {
  console.log(`[Saeda] :  19 `);
  console.log(`Hi ${client19.user.tag} , This Code by : Saeda `);
  console.log(`i Have  [ " ${client19.guilds.size} " ]`);
});
client20.on("ready", () => {
  console.log(`[Saeda] :   20 `);
  console.log(`Hi ${client20.user.tag} , This Code by : Saeda `);
